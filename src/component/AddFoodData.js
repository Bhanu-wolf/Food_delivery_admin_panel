    ...
    <div className="form-outer">
      ...
      <form className="form-inner">
        ...
        <input
          type="text"
          name="food_name"
          onChange={(text) => setFoodName(text.target.value)}
        />
        <br />
        ...
        <input
          ...
          onChange={(text) => setFoodDescription(text.target.value)}
        />
        <br />
        ...
        <input
          type="file"
          name="food_image"
          onChange={(text) => setFoodImage(text.target.files[0])}
        />
        <br />
        ...
        <input
          ...
          onChange={(text) => setRestaurantName(text.target.value)}
        />
        <br />
        <div class="form-row">
          <div class="form-col">
